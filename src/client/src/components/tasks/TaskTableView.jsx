                      ...
                      <div>
                        ...
                        {task.estimatedHours && (
                          <div className="text-xs text-gray-500 mt-1">
                            / {parseFloat(task.estimatedHours.toFixed(2))}h est.
                          </div>
                        )}
                      </div>
                    ) : (
                      <span className="text-gray-400">
                        {task.estimatedHours ? `${parseFloat(task.estimatedHours.toFixed(2))}h est.` : '-'}
                      </span>
                    )}
                  </div>
                </td>
                  ...
                  <div className="flex items-center">
                    <div className="w-16 bg-gray-200 rounded-full h-2 mr-2">
                      <div
                        ...
                        style={{ width: `${Math.min(parseFloat(formatPercentage(task.completionPercentage || 0)), 100)}%` }}
                      ></div>
                    </div>
                    <span className="text-xs text-gray-600">
                      {formatPercentage(task.completionPercentage || 0)}%
                    </span>
                  </div>
                </td>
              </tr>
