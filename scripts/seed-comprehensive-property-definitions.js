...
const propertyDefinitions = [
  ...
  // ============================================
  {
    ...
    display: { inputType: 'select', placeholder: 'Select diameter' },
    useStandardValuesAsDropdown: true,
    standardValues: [
      { displayValue: '1/2"', normalizedValue: 0.5, aliases: ['0.5', '1/2', '0.5"'] },
      { displayValue: '3/4"', normalizedValue: 0.75, aliases: ['0.75', '3/4', '0.75"'] },
  ...
  },
  {
    ...
    display: { inputType: 'select', placeholder: 'Select thickness' },
    useStandardValuesAsDropdown: true,
    standardValues: [
      { displayValue: '1/2"', normalizedValue: 0.5, aliases: ['0.5', '1/2', '0.5"'] },
      { displayValue: '1"', normalizedValue: 1.0, aliases: ['1', '1.0', '1"'] },
      { displayValue: '1 1/2"', normalizedValue: 1.5, aliases: ['1.5', '1-1/2', '1.5"', '1 1/2'] },
      { displayValue: '2"', normalizedValue: 2.0, aliases: ['2', '2.0', '2"'] },
      { displayValue: '2.2"', normalizedValue: 2.2, aliases: ['2.2', '2.2"'] },
      { displayValue: '2 1/2"', normalizedValue: 2.5, aliases: ['2.5', '2-1/2', '2.5"', '2 1/2'] },
      { displayValue: '3"', normalizedValue: 3.0, aliases: ['3', '3.0', '3"'] },
      { displayValue: '3 1/2"', normalizedValue: 3.5, aliases: ['3.5', '3-1/2', '3.5"', '3 1/2'] },
      { displayValue: '4"', normalizedValue: 4.0, aliases: ['4', '4.0', '4"'] }
  ...
  },
  {
    ...
    unitSystem: 'imperial',
    normalization: { function: 'parseInches', tolerance: 0.01 },
    display: { inputType: 'select', placeholder: 'Select width' },
    useStandardValuesAsDropdown: true,
    standardValues: [
      { displayValue: '3"', normalizedValue: 3.0, aliases: ['3', '3.0'] },
      { displayValue: '6"', normalizedValue: 6.0, aliases: ['6', '6.0'] },
      { displayValue: '12"', normalizedValue: 12.0, aliases: ['12', '12.0', '1ft'] },
      { displayValue: '18"', normalizedValue: 18.0, aliases: ['18', '18.0', '1.5ft'] },
      { displayValue: '24"', normalizedValue: 24.0, aliases: ['24', '24.0', '2ft'] },
      { displayValue: '30"', normalizedValue: 30.0, aliases: ['30', '30.0', '2.5ft'] },
      { displayValue: '36"', normalizedValue: 36.0, aliases: ['36', '36.0', '3ft'] },
      { displayValue: '42"', normalizedValue: 42.0, aliases: ['42', '42.0', '3.5ft'] },
      { displayValue: '47"', normalizedValue: 47.0, aliases: ['47', '47.0'] },
      { displayValue: '48"', normalizedValue: 48.0, aliases: ['48', '48.0', '4ft'] },
      { displayValue: '56"', normalizedValue: 56.0, aliases: ['56', '56.0'] },
      { displayValue: '59"', normalizedValue: 59.0, aliases: ['59', '59.0'] }
    ]
  },
  {
    key: 'height',
    ...
    unitSystem: 'imperial',
    normalization: { function: 'parseInches', tolerance: 0.01 },
    display: { inputType: 'select', placeholder: 'Select height' },
    useStandardValuesAsDropdown: true,
    standardValues: [
      { displayValue: '3"', normalizedValue: 3.0, aliases: ['3', '3.0'] },
      { displayValue: '6"', normalizedValue: 6.0, aliases: ['6', '6.0'] },
